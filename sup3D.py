...
def hello():
    column1 = ["artless", "bawdy", "beslubbering", "bootless", "churlish", "cockered", "clouted", "craven", "currish",
    ...
    column3 = ["apple-john", "baggage", "barnacle", "bladder", "boar-pig", "bugbear", "bum-bailey", "canker-blossom",
    ...
    return ("thou " + column1[random.randint(0, 49)] + (" ") + column2[random.randint(1, 49)] + (" ") + column3[
        random.randint(1, 49)])
